(module
 ...
 (type $FUNCSIG$fffiii (func (param f32 f32 i32 i32 i32) (result f32)))
 ...
 (export "wasmCalculateAdultAndChildBaseFareForBooking" (func $assembly/index/wasmCalculateAdultAndChildBaseFareForBooking))
 ...
 (func $assembly/index/wasmCalculateAdultAndChildBaseFareForBooking (; 26 ;) (type $FUNCSIG$fffiii) (param $0 f32) (param $1 f32) (param $2 i32) (param $3 i32) (param $4 i32) (result f32)
  local.get $0
  local.get $1
  local.get $4
  f32.convert_i32_u
